...
public abstract class CsvInserts {
    ...
    public static String mc15 = "9,SVB,NL,2121FF, cynapol ,12, ga,Assen,8, fred jansen,543214457,fjansen@calco.nl";
    public static String mc17 = "9,SVB,NL,4455HG,daustrasse,34,a,rotterdam,7,edgar jansen-zoon,'061267311',ezoon@calco.nl";
    public static String mc18 = "9,SVB,NL,4412JJ,winsteeg,34,a,den haag,5,edgar Hanso,0612673177,eHanso@calco.nl";
    public static String mc19 = "9,SVB,NL,4422JK,windgasse,34,a,rotterdam,1,willem jansen,0612654532,wjansen@calco.nl";
    public static String mc20 = "9,SVB,NL,2122KK,raamweg,34,a,vlaardingen,2,thai ni,06324209877,tni@calco.nl";
    public static String mc21 = "9,SVB,NL,9012KK,daulaan,34,a,rotterdam,4,xi japon,0632432141,xjapon@calco.nl";
    public static String mc22 = "9,SVB,NL,1235JJ,witsteeg,34,a,schiedam,3,francois la leutre,0612334123,fleutren@calco.nl";
    public static String mc23 = "9,SVB,NL,9089KK,blauwstraat,34,a,den helder,4,vido dido,0614231444,vdido@calco.nl";
    public static String mc24 = "9,SVB,NL,2112JJ,rodenlaan,34,a,kappelle,6,fred flinstonw,0612532133,fflinstow@calco.nl";
    public static String mc25 = "9,SVB,NL,1122JH,laardingerweg,34,a,Zwolle,7,kadae,0612341223,kadae@calco.nl";
